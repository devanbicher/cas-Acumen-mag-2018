       ...
       <div id="feature-title-region">
           <?php if ($title): ?>
             <div class="title-wrapper">
               <div class="feature-sub-wrapper">
                 <div class="pt-features">Features</div>
               </div>
             </div>
             <div class="feature-page-title"><?php print $title; ?></div>
           <?php endif; ?>
         <div class="feature-summary">
           <?php print '<div class="feature-fields-wrapper"><div id="feature-tag-line">'.$node->field_tag_line['und'][0]['value'].'</div>' ?>
           <?php print '<div id="feature-author">By '.$node->field_author['und'][0]['value'].'</div></div>' ?>
         </div>
