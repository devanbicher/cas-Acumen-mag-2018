  ...
  <div id="page" class="container <?php print $classes; ?>">
    ...
    <?php print render($page['leaderboard']); ?>
      ...
      <div id="lehigh-header">
            ...
            <div id="cas-logo">
              <a href="https://cas.cas2.lehigh.edu/">College&nbsp;of</br>Arts&nbsp;and</br>Sciences</a>
            </div>
          <?php endif; ?>
      </div>
        <!-- !Branding -->
    ...
    <?php print render($page['highlighted']); ?>
       <div id="feature-title-region">
           <?php if ($title): ?>
           <div class="feature-page-title"><?php print $title; ?></div>
         <?php endif; ?>
         <div class="feature-summary">
           <?php print '<div class="feature-fields-wrapper"><div id="feature-tag-line" class="brief-dept">' ?>
             <?php if ($node->field_department): print get_dept_title($node->field_department['und'][0]['tid']); endif;?>
           <?php print '</div><div id="feature-author">By '.$node->field_author['und'][0]['value'].'</div></div>' ?>
         </div>
       </div>
