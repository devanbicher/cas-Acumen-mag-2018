 ...
 *
 * Old code snippet for the cover image path, I don't think this works due to this version of php
 *   <?php $cover_path='http://'.explode('/',path_to_theme())[1].'/'.variable_get('file_public_path').'/';?>
 *
 */
?>
<div id="page-wrapper">
  <div id="page" class="container <?php print $classes; ?>">
    ...
    <?php print render($page['leaderboard']); ?>
      ...
      <div id="lehigh-header">
            ...
            <div id="cas-logo">
              <a href="http://cas.cas2.lehigh.edu/">College&nbsp;of</br>Arts&nbsp;and</br>Sciences</a>
            </div>
          <?php endif; ?>
      </div>
        <!-- !Branding -->
           <div id="header-wrap">
             <div id="headertext">
               <a href="/" id="title-a">
                 <div id="title">acumen</div>
                 <div id="dept">The magazine of Lehigh University&apos;s College of Arts and Sciences</div>
               </a>
             </div>
           </div>
    ...
    <?php print render($page['highlighted']); ?>
       <div id="issue-title-region">
         <div class="title-wrapper">
           <?php if ($title): ?>
             <div class="title-sub-wrapper">
		<?php $cover_path='http://acumen.cas.lehigh.edu/sites/acumen.cas.lehigh.edu/files/'; ?>
               <?php  print '<img src="'.$cover_path.$node->field_issue_cover['und'][0]['filename'].'">' ?>
             <div class="page-title">
               <?php print 'Acumen '.$title; ?>
             </div>
             <div class="pt-features">Features</div></div>
           <?php endif; ?>
         </div>
       </div>
        ...
        <div class="content-inner">
          <<?php print $tag; ?> id="main-content">
            ...
            <?php if ($content = render($page['content'])): ?>
              ...
              <?php if (!empty($node)): ?>
                  <?php if ($node->type == 'feature'): ?>
                      <div id="features-prev-next">
                         <?php print display_features_prev_next($node); ?>
                      </div> 
                  <?php endif; ?>
             <?php endif; ?>
